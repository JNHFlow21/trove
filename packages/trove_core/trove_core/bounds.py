...
MOMENT_TIMELINE = BoundSpec(1, 100, 50)
MOMENT_INTERACTIONS = BoundSpec(1, 100, 50)
FAVORITES_LIST = BoundSpec(1, 100, 50)
MESSAGE_STATS = BoundSpec(1, 50, 10)
PENDING_REPLIES = BoundSpec(1, 50, 20)
MESSAGES_BY_KIND = BoundSpec(1, 50, 20)
MEDIA_ENRICH_PLAN = BoundSpec(1, 1000, 200)
